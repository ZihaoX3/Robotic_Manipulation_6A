...
%     plotCoordFrame(T0_1, link1end);
%     plotCoordFrame(T0_2, link2end);
%     plotCoordFrame(T0_3, link3end);
%     plotCoordFrame(T0_4, end_effector_pos);
...
function plotCoordFrame(transform, start)
...
%     line([start(1) start(1)+z_dir(1)],[start(2) start(2)+z_dir(2)],[start(3) start(3)+z_dir(3)],'LineWidth',1,'Color','green');
    plot3([start(1) start(1)+x_dir(1)],[start(2) start(2)+x_dir(2)],[start(3) start(3)+x_dir(3)],'LineWidth',1,'Color','red');
    plot3([start(1) start(1)+y_dir(1)],[start(2) start(2)+y_dir(2)],[start(3) start(3)+y_dir(3)],'LineWidth',1,'Color','blue');
    plot3([start(1) start(1)+z_dir(1)],[start(2) start(2)+z_dir(2)],[start(3) start(3)+z_dir(3)],'LineWidth',1,'Color','green');
